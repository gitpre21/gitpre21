...
if(isset($_POST['add'])){
    ...
    $conn->query("INSERT INTO courses(course_name, faculty_id) VALUES('$name','$faculty_id')");
}
...
$courses = $conn->query("SELECT c.course_id, c.course_name, f.faculty_name 
                         FROM courses c LEFT JOIN faculties f ON c.faculty_id=f.faculty_id");
...
<head>
<meta charset="UTF-8">
<title>Manage Courses - EduCore</title>
...
<div class="glass-card">
    <h2 class="animated-gradient-text">Manage Courses</h2>
    ...
    <form method="POST" class="mb-3">
        ...
        <button name="add" class="btn btn-success">Add Course</button>
    </form>
    ...
    <table class="table table-bordered">
        ...
        <?php while($row=$courses->fetch_assoc()){ ?>
            <tr>
                ...
                <td>
                    <a href="?delete=<?= $row['course_id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this course?')">Delete</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
