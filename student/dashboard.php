...
<aside class="side-menu" id="sideMenu">
    <a href="student_profile.php"><i class="bi bi-person"></i> View Profile</a>
    <a href="view_class.php"><i class="bi bi-building"></i> View Class</a>
    <a href="enroll_subjects.php"><i class="bi bi-book"></i> Enroll Subjects</a>
    <a href="view_grades.php"><i class="bi bi-bar-chart"></i> View Grades</a>
    <a href="billing.php"><i class="bi bi-cash"></i> Billings</a>
...
<main>
    <div class="content-card">
        ...
        <p class="mt-3 fs-5">
            Your hub to track your progress, access assignments, stay informed, and keep your learning journey organized and inspired. 🎯
        </p>
    </div>
</main>
